...
public:
   ...
   */
  TaskBase(FilesystemBase* aFilesystem);
...
protected:
   ...
   */
  virtual FilesystemParams GetRequestParams(const nsString& aFilesystem) const = 0;
   ...
   */
  virtual FilesystemResponseValue GetSuccessRequestResult() const = 0;
  ...
  bool HasError() const { return mErrorValue != NS_OK; }
